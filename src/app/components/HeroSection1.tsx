...
export default function HeroSection1() {
  ...
  className="bg-gradient-to-br from-white to-[#fdf3ff] py-20 px-4 md:px-10 lg:px-20 overflow-hidden"
>
  <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between w-full gap-12">
    {/* Left Content */}
