        ...
        <div className="flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="space-y-4 max-w-md">
            ...
            <div className="flex gap-4">
              ...
              <Link href="/" className="font-bold font-serif">
                <Image src="/img/footerIcon2.svg" alt="Logo" width={140} height={20} />
              </Link>
            </div>{" "}
             <div className="text-2xl font-bold">
              <Link href="/" className="font-bold font-serif">
                <Image src="/img/footerIcon1.svg" alt="Logo" width={80} height={20} />
              </Link>
            </div>{" "}
            </div>
            <p className="text-sm text-[#FFFFFFCC]">
              Insurbe GmbH is a registered insurance intermediary in <br/>  Germany 
              (BaFin regulated)
            </p>
          </div>
