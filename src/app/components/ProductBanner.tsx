...
export default function ProductBanner() {
  return (
    <section className="bg-gradient-to-br from-white to-[#fdf3ff] py-16 px-4 text-center">
   ...
   <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 max-w-3xl mx-auto px-4">
