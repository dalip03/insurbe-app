...
import { Mail, Lock, Eye, EyeOff, UserPlus, Shield, Sparkles, AlertCircle, LogOut, LogInIcon } from "lucide-react";
      ...
      >
        ...
        >
          ...
          <h1 className="text-4xl font-extrabold text-gray-900 mb-2">
            Create <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-primary">Account</span>
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {loading ? (
                <>
                  <motion.div
                    ...
                    className="w-5 h-5 border-2 border-white cursor-pointer border-t-transparent rounded-full"
                  />
                  Creating account...
                </>
              ) : (
          ...
          >
            ...
            <Link href="/login" className="font-semibold text-purple-600 hover:text-purple-700 hover:underline transition">
              Login
            </Link>
          </motion.p>
        </form>
